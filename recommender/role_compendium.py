...
def _construct_trick_room_setter(
    ...
    *,
    ...
    from recommender.role_compendium_setup import _delivery_usage_hits
...
def _screens_dual_usage(
    ...
    *,
    ...
    from recommender.role_compendium_setup import _same_row_both_moves
...
def _construct_screens_support(
    ...
    *,
    ...
    from recommender.role_compendium_setup import _delivery_usage_hits, _usage_has_item
