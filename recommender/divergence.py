...
_SECONDARY_ROLE_TAGS: dict[str, str] = {
    ...
    "electric_terrain_setter": "provides_electric_terrain",
    "grassy_terrain_setter": "provides_grassy_terrain",
    "psychic_terrain_setter": "provides_psychic_terrain",
    "misty_terrain_setter": "provides_misty_terrain",
