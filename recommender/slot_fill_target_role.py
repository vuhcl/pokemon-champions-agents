...
_CONDITION_SETTER_TARGET_ROLES: dict[str, tuple[TargetRoleId, str]] = {
    ...
    "electric": ("electric_terrain_setter", "role:electric_terrain_setter"),
    "grassy": ("grassy_terrain_setter", "role:grassy_terrain_setter"),
    "psychic": ("psychic_terrain_setter", "role:psychic_terrain_setter"),
}
REVIEWED_STRATEGIC_TARGET_ROLES: dict[str, TargetRoleId] = {
    ...
    "electricterrainsetter": "electric_terrain_setter",
    "grassyterrainsetter": "grassy_terrain_setter",
    "psychicterrainsetter": "psychic_terrain_setter",
    "mistyterrainsetter": "misty_terrain_setter",
